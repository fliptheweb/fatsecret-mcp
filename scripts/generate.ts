#!/usr/bin/env npx tsx
/**
 * Full pipeline: Postman Collection → Split by Auth → OpenAPI → TypeScript Types
 *
...
console.log('\n📦 Step 1: Splitting Postman collection by auth type...');
...
// Step 3: Fix base URLs (Postman variables → actual URLs)
console.log('\n🔧 Step 3: Fixing base URLs...');
...
// Step 4: Generate TypeScript types (openapi-typescript → .d.ts)
